...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('phone_number', 'name', 'email_address', 'date_of_birth')
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('phone_number', 'name', 'email_address',
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('phone_number', 'name', 'email_address',
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('phone_number', 'name', 'email_address', 'date_of_birth', 'password1', 'password2'),
        }),
    )
